      ...
      try {
        ...
        const claudeRes = await fetch('https://api.anthropic.com/v1/messages', {
          ...
          body: JSON.stringify({
            ...
            messages: [{
              role: 'user',
              content: `Erstelle eine vollständige strukturierte Zusammenfassung des folgenden Dokuments. Decke ALLE folgenden Punkte ab, sofern im Dokument vorhanden. Lasse keinen aus:\n\n1. Fördersätze & Beträge: Alle Prozentsätze, Eurobeträge, Obergrenzen, Boni und Höchstbeträge mit exakten Zahlen.\n\n2. Antragsberechtigte: Wer darf den Antrag stellen? Nenne alle Gruppen explizit (z.B. Privatpersonen, Eigentümer, Vermieter, WEG, Unternehmen, Gemeinden). Unterscheide wenn nötig nach Eigentümertyp.\n\n3. Explizite Ausschlüsse: Wer ist ausdrücklich NICHT antragsberechtigt? (z.B. GbR, bestimmte Unternehmenstypen, Körperschaften des öffentlichen Rechts). Welche Gebäudetypen, Maßnahmen oder Situationen sind ausdrücklich ausgeschlossen?\n\n4. Antragstellung & Antragsablauf: Beschreibe den vollständigen Ablauf der Antragstellung. Verwende dabei diese Begriffe wörtlich, sofern sie im Dokument vorkommen: „Antragstellung", „Unterlagen", „erforderliche Dokumente", „Nachweise". Beantworte insbesondere:\n   - Wann muss die Antragstellung erfolgen (vor/nach Vorhabenbeginn)?\n   - Was gilt laut Dokument als Vorhabenbeginn?\n   - Welche Rolle spielen Lieferungsverträge mit aufschiebender oder auflösender Bedingung?\n   - Wer nimmt die Antragstellung vor (Antragsteller, Energieberater, Fachunternehmen)?\n   - Über welchen Kanal erfolgt die Antragstellung (online, Bankdurchleitung, Fachunternehmen)?\n\n5. Erforderliche Unterlagen, Nachweise & Bestätigungen: Liste alle Unterlagen, Nachweise und Bestätigungen auf, die für die Antragstellung oder den Mittelabruf erforderlich sind. Verwende dabei folgende Begriffe wörtlich, sofern sie im Dokument vorkommen: „BzA", „Bestätigung zum Antrag", „Nachweise", „Unterlagen", „erforderliche Dokumente". Nenne insbesondere: Bestätigung zum Antrag (BzA), Energieberaterbescheinigung, Fachunternehmerbestätigung, Rechnungen, Verwendungsnachweise.\n\n6. Wichtige Bedingungen & Voraussetzungen: Technische oder rechtliche Mindestanforderungen (z.B. Gebäudealter, Effizienzklasse, Mindestinvestition, Pflicht zur Fachplanung oder Energieberatung).\n\n7. Fristen & Termine: Alle relevanten Deadlines, Gültigkeitszeiträume, Abruffristen.\n\n8. Kombinierbarkeit: Mit welchen anderen Programmen kombinierbar oder ausdrücklich nicht kombinierbar?\n\nWICHTIG: Wenn das Dokument einen Antragsablauf beschreibt, müssen in der Zusammenfassung die Begriffe „Unterlagen", „Antragstellung", „Nachweise" und – sofern im Dokument erwähnt – „BzA", „Bestätigung zum Antrag" und „erforderliche Dokumente" explizit vorkommen.\n\nSchreibe nur die Zusammenfassung ohne einleitenden Satz. Nenne Zahlen, Begriffe und Regelungen exakt wie im Dokument.\n\n${doc_text.substring(0, 3000)}`,
            }],
          }),
        });
